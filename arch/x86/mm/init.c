...
void __init poking_init(void)
{
	 ...
	 */
#ifdef CONFIG_ENHANCED_INTERFACE
	ptep = get_locked_tentry_pte(poking_mm, poking_addr, &tentry, &ptl);
	// BUG_ON(!ptep);
	
	insert_tentry(poking_mm, poking_addr, &tentry, PG_LEVEL_PTE, gen_pte);
	clear_tentry(poking_mm, poking_addr, &tentry, PG_LEVEL_PTE);
